  ...
  <main class="wishlist-page">
    ...
    <section class="wishlist-hero">
      <div class="container">
        ...
        <p class="wishlist-hero__desc">
          Retrouvez les produits qui vous ont fait craquer.
        </p>
      </div>
    </section>
    ...
    <div class="container wishlist-content">
      ...
      <div v-else-if="wishlist.items.length === 0" class="wishlist-empty card">
        ...
        <h2 class="display-md">Aucun favori pour le moment</h2>
        <p>Parcourez notre collection et ajoutez vos coups de cœur.</p>
      ...
      <!-- Liste -->
      <template v-else>
        <p class="wishlist-count">{{ wishlist.items.length }} article{{ wishlist.items.length > 1 ? 's' : '' }}</p>
        ...
        <div class="wishlist-grid">
          ...
          >
            ...
            <RouterLink :to="`/products/${item.product_slug}`" class="wishlist-card__img-wrap">
              ...
              <!-- Badge rupture -->
              <span v-if="item.product_stock === 0" class="wishlist-card__badge">Épuisé</span>
              <!-- Badge promo -->
            ...
            <div class="wishlist-card__body">
              ...
              <p class="wishlist-card__date">Ajouté le {{ formatDate(item.added_at) }}</p>
            </div>
            ...
            <div class="wishlist-card__actions">
              ...
              >
                ...
                {{ addingId === item.product_id ? '…' : 'Ajouter au panier' }}
              </button>
              <span v-else class="wishlist-card__stock-badge">Rupture de stock</span>
