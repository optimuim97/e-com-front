  ...
  <main class="orders-page">
    ...
    <section class="orders-hero">
      <div class="container">
        ...
        <p class="orders-hero__desc">Retrouvez l'historique de tous vos soins Rosa Beauty.</p>
      </div>
    </section>
    ...
    <div class="container orders-content">
      ...
      <div v-else-if="orders.length === 0" class="orders-empty card">
        ...
        <h2 class="display-md">Aucune commande pour le moment</h2>
        <p>Découvrez notre collection et offrez-vous un soin signature.</p>
      ...
      <div v-else class="orders-list">
        <div v-for="order in orders" :key="order.id" class="order-row card card-hover">
          <div class="order-row__main">
            ...
            <p class="order-row__items">{{ order.items?.length ?? '—' }} article(s)</p>
          </div>
