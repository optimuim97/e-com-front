    ...
    <div class="pin-modal__card">
      <header class="pin-modal__header">
        <div>
          ...
          <h2 class="pin-modal__title">Modifier mon code PIN</h2>
        </div>
        <button @click="$emit('close')" class="pin-modal__close" aria-label="Fermer">
      ...
      <p v-if="success" class="pin-modal__msg pin-modal__msg--success">✓ Code PIN modifié avec succès.</p>
