      ...
      <div class="container footer__grid">
        ...
        <div class="footer__brand">
          ...
          <p class="footer__brand-desc">
            Des soins naturels à base d'eau de rose pure pour révéler votre beauté naturelle.
            Formulés avec amour, fabriqués en Côte d'Ivoire.
          </p>
          <!-- Réseaux sociaux -->
          ...
          <!-- WhatsApp -->
          <a
            href="https://wa.me/2250585825555"
            target="_blank"
            rel="noopener"
    ...
    <div class="footer__bottom">
      <div class="container footer__bottom-inner">
        <p class="footer__copy">
          © {{ currentYear }} Rosa Beauty Facial Care. Tous droits réservés.
        </p>
        ...
        <div class="footer__payments">
          <span class="footer__payment" v-for="p in payments" :key="p" :title="p">{{ p }}</span>
        </div>
      </div>
    </div>
  </footer>
...
const socials = [
  {
    name: 'Facebook',
    url: 'https://web.facebook.com/profile.php?id=100083989341314',
  ...
  },
  {
    name: 'Instagram',
    url: '#',
    icon: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>`,
  },
  {
    name: 'TikTok',
    url: '#',
    icon: `<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V9.19a8.2 8.2 0 0 0 4.78 1.52V7.27a4.85 4.85 0 0 1-1.01-.58z"/></svg>`,
  },
]
...
const payments = ['Wave', 'Orange Money', 'Stripe', 'PayPal']
</script>
